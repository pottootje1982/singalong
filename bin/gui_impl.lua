...
-- Average time a http request takes (for use in progress bar)
...
testButton = iup.button{title="launch test.lua",expand="YES"}
function testButton:action()
  dofile 'test.lua'
end

reloadButton = iup.button{title="launch reload.lua",expand="YES"}
