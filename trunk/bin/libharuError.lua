...
local errorCodes =
{
  ...
  [0x1011] = [[Tried to set the owner password to NULL. The owner password and user password is the same.]],
  ...
  [0x101A] = [[The format of a font-file is invalid. Internal error. The consistency of the data was lost.]],
...
libharuError = function(errorCode, detail)
  iup.Message('PDF generation error', string.format('Libharu error: %s\nDetail: %d', errorCodes[errorCode], detail))
end
